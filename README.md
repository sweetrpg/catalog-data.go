...
[![Unit tests](https://github.com/sweetrpg/catalog-data.go/actions/workflows/go-ci.yml/badge.svg)](https://github.com/sweetrpg/catalog-data.go/actions/workflows/go-ci.yml)
...
Documentation for this package can be found [here](https://sweetrpg.github.io/catalog-data.go).
